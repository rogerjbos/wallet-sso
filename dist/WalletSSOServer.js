...
exports.WalletSSOServer = void 0;
const express_1 = __importDefault(require("express"));
const express_session_1 = __importDefault(require("express-session"));
const cors_1 = __importDefault(require("cors"));
const WalletSSO_1 = require("./WalletSSO");
class WalletSSOServer {
    constructor(config) {
        this.config = config;
        this.sso = new WalletSSO_1.WalletSSO(config);
...
exports.WalletSSOServer = WalletSSOServer;
//# sourceMappingURL=WalletSSOServer.js.map