...
const { WalletSSO } = require('../../dist/WalletSSO.js');
const { WalletType } = require('../../dist/types.js');
...
const WHITELISTED_ADDRESSES = [
    ...
    '5GZKsBNX5A6PdF13kV8Dc6RsEQinQBKwTsLd5e7vkSM9JFV3', // In production, load from database/smart contract
    '15M8...',
    '12MZ...',
    '13ZK...',
];
// Normalize SS58 addresses to comparable public key hex
function toPublicKeyHex(addr) {
    try {
...
const WHITELIST_PUBKEYS = new Set(WHITELISTED_ADDRESSES
    .map(toPublicKeyHex)
    .filter((x) => !!x));
...
function restrictToWhitelistedAddresses(req, res, next) {
